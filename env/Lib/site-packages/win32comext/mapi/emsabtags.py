...
from .mapitags import (PROP_TAG, PT_APPTIME, PT_BINARY, PT_BOOLEAN, PT_CLSID,
                       PT_CURRENCY, PT_DOUBLE, PT_ERROR, PT_FLOAT, PT_I2,
                       PT_I4, PT_I8, PT_LONG, PT_LONGLONG, PT_MV_APPTIME,
                       PT_MV_BINARY, PT_MV_CLSID, PT_MV_CURRENCY, PT_MV_DOUBLE,
                       PT_MV_FLOAT, PT_MV_I2, PT_MV_I4, PT_MV_I8, PT_MV_LONG,
                       PT_MV_LONGLONG, PT_MV_R4, PT_MV_R8, PT_MV_SHORT,
                       PT_MV_STRING8, PT_MV_SYSTIME, PT_MV_TSTRING,
                       PT_MV_UNICODE, PT_NULL, PT_OBJECT, PT_R4, PT_SHORT,
                       PT_STRING8, PT_SYSTIME, PT_TSTRING, PT_UNICODE,
                       PT_UNSPECIFIED)
