...
from traitlets.traitlets import (CaselessStrEnum, Dict, Enum, Float, FuzzyEnum,
                                 Integer, List, Set, Unicode,
...
class TestConfigurable(TestCase):
    ...
    def test_generated_config_enum_comments(self):
        class MyConf(Configurable):
            an_enum = Enum("Choice1 choice2".split(), help="Many choices.").tag(
                config=True
            )
        ...
        self.assertGreater(
            cls2_msg.index(defaults_str), cls2_msg.index(enum_choices_str)
        )
        ...
        # Check order of Default <--> Choices sections
        self.assertGreater(
            cls2_cfg.index(defaults_str), cls2_cfg.index(enum_choices_str)
        )
    ...
    def test_generated_config_strenum_comments(self):
        ...
        # Check order of Default <--> Choices sections
        self.assertGreater(
            cls3_msg.index(defaults_str), cls3_msg.index(enum_choices_str)
        )
        ...
        # Check order of Default <--> Choices sections
        self.assertGreater(
            cls3_cfg.index(defaults_str), cls3_cfg.index(enum_choices_str)
        )
        ...
        enum_choices_str = (
            "Choices: any case-insensitive prefix of ['Choice1', 'choice2']"
        )
        ...
        # Check order of Default <--> Choices sections
        self.assertGreater(
            cls4_msg.index(defaults_str), cls4_msg.index(enum_choices_str)
        )
        ...
        # Check order of Default <--> Choices sections
        self.assertGreater(
            cls4_cfg.index(defaults_str), cls4_cfg.index(enum_choices_str)
        )
...
class TestLogger(TestCase):
    ...
    @mark.skipif(
        not hasattr(TestCase, "assertLogs"), reason="requires TestCase.assertLogs"
    )
