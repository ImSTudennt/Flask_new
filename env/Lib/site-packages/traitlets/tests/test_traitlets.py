...
import pytest
from traitlets import (All, Any, BaseDescriptor, Bool, Bytes, Callable, CBytes,
                       CFloat, CInt, CLong, Complex, CRegExp, CUnicode, Dict,
                       DottedObjectName, Enum, Float, ForwardDeclaredInstance,
                       ForwardDeclaredType, HasDescriptors, HasTraits,
                       Instance, Int, Integer, List, Long, MetaHasTraits,
                       ObjectName, Set, TCPAddress, This, TraitError,
                       TraitType, Tuple, Type, Undefined, Unicode, Union,
                       default, directional_link, link, observe,
                       observe_compat, traitlets, validate)
...
def test_all_attribute():
    ...
    for name in names:
        ...
        if (
            ...
            and issubclass(value, TraitType)
        ):
