...
from posix import \
    listdir as \
    listdir  # TODO: use this, see https://github.com/python/mypy/issues/3078
from posix import stat_result as stat_result
from typing import (IO, Any, AnyStr, Callable, Dict, Generic, Iterator, List,
                    Mapping, MutableMapping, NamedTuple, NoReturn, Optional,
                    Sequence, Set, Text, Tuple, TypeVar, Union, overload)
