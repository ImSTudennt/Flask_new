...
from jedi.inference.base_value import (NO_VALUES, Value, ValueSet,
                                       ValueWrapper, iterator_to_value_set)
...
from jedi.inference.names import (NameWrapper, ParamName, TreeNameDefinition,
                                  ValueName)
from jedi.inference.value.dynamic_arrays import get_dynamic_array_instance
from jedi.inference.value.function import (BaseFunctionExecutionContext,
                                           FunctionExecutionContext,
                                           FunctionMixin, FunctionNameInClass,
                                           FunctionValue,
...
class TreeInstance(_BaseTreeInstance):
    ...
    def _get_annotated_class_object(self):
        from jedi.inference.gradual.annotation import (
            infer_type_vars_for_execution, py__annotations__)
