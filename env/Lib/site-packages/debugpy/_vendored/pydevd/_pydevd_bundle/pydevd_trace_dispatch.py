...
from _pydevd_bundle.pydevd_constants import (ENV_FALSE_LOWER_VALUES,
...
if USE_CYTHON_FLAG in ENV_TRUE_LOWER_VALUES:
    ...
    from _pydevd_bundle.pydevd_cython_wrapper import (
        fix_top_level_trace_and_get_trace_func, global_cache_frame_skips,
        global_cache_skips, trace_dispatch)

    USING_CYTHON = True

elif USE_CYTHON_FLAG in ENV_FALSE_LOWER_VALUES:
    # Use the regular version if not forcing cython
    from _pydevd_bundle.pydevd_trace_dispatch_regular import (  # @UnusedImport
        fix_top_level_trace_and_get_trace_func, global_cache_frame_skips,
        global_cache_skips, trace_dispatch)
