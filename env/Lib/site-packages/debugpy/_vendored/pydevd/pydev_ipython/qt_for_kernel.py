...
from pydev_ipython.qt_loaders import (QT_API_PYQT, QT_API_PYQT5,
                                      QT_API_PYQT_DEFAULT, QT_API_PYSIDE,
                                      QT_API_PYSIDE2, load_qt, loaded_api)
...
if api_opts is not None:
    ...
    from pydev_ipython.qt import QT_API, QtCore, QtGui, QtSvg
