...
from _pydevd_bundle.pydevd_constants import (
    ENV_FALSE_LOWER_VALUES, ENV_TRUE_LOWER_VALUES, IS_PY36_OR_GREATER,
    IS_PY38_OR_GREATER, IS_PYTHON_STACKLESS,
    PYDEVD_IPYTHON_COMPATIBLE_DEBUGGING, PYDEVD_USE_FRAME_EVAL, SUPPORT_GEVENT,
    USE_CYTHON_FLAG)
...
if (
    ...
    from _pydevd_frame_eval.pydevd_frame_eval_cython_wrapper import (
        clear_thread_local_info, dummy_trace_dispatch, frame_eval_func,
        stop_frame_eval)
