...
import psutil
import psutil.tests
from psutil import LINUX, POSIX, WINDOWS
...
from psutil.tests import (APPVEYOR, CI_TESTING, HAS_BATTERY, HAS_MEMORY_MAPS,
                          HAS_NET_IO_COUNTERS, HAS_SENSORS_BATTERY,
                          HAS_SENSORS_FANS, HAS_SENSORS_TEMPERATURES,
                          PYTHON_EXE, PYTHON_EXE_ENV, SCRIPTS_DIR,
                          PsutilTestCase, mock, reload_module, sh)
