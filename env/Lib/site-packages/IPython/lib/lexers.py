...
from pygments.lexer import (DelegatingLexer, Lexer, RegexLexer, bygroups,
                            do_insertions, using)
# Third party
from pygments.lexers import (BashLexer, HtmlLexer, JavascriptLexer, PerlLexer,
                             Python3Lexer, PythonLexer, RubyLexer, TexLexer)
from pygments.token import (Error, Generic, Keyword, Literal, Name, Operator,
                            Other, Text)
