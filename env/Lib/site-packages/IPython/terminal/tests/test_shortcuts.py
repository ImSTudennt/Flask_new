...
from IPython.terminal.shortcuts.auto_suggest import (
    NavigableAutoSuggestFromHistory, accept, accept_and_keep_cursor,
    accept_character, accept_or_jump_to_end, accept_token, accept_word,
    discard, swap_autosuggestion_down, swap_autosuggestion_up)
